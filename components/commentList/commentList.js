...
Component({
  ...
  methods: {
    ...
    async showList(e) {
      ...
      // console.log(typeof (e.currentTarget.dataset.commentid));
    ...
    async getCommentList(id, page) {
      ...
      let commentData = await request('/comment/new', { id, pageSize: 50, pageNo: page, sortType: 2, type: resourceTypeNum });
